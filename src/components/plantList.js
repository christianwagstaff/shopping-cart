...
const plantList = [
  { name: "Bonzai", price: 230, img: bonzai1, id: 1 },
  { name: "Bonzai (Tall)", price: 530, img: bonzai2, id: 2 },
  { name: "Stilted Leaf", price: 25, img: roundLeaf, id: 3 },
  { name: "Purple Flowers", price: 15, img: shortPurple, id: 4 },
  { name: "Flute Plant", price: 20, img: tallPurple, id: 5 },
  { name: "Money Tree", price: 10, img: leaf, id: 6 },
  { name: "Monstera", price: 50, img: monstera, id: 7 },
  { name: "Orchids", price: 20, img: orchids, id: 8 },
  { name: "Flowering Succulent", price: 34, img: flowingSucculent, id: 9 },
  { name: "Beaded Succulent", price: 45, img: beaded, id: 10 },
  { name: "Snake Plant", price: 20, img: snakePlant, id: 11 },
  { name: "Succulent", price: 12, img: sideSucculent, id: 12 },
  { name: "Purple Succulent", price: 15, img: purpleSucculent, id: 13 },
  { name: "Classic House", price: 20, img: leafy, id: 14 },
];
